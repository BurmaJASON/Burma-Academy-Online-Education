        ...
        <div class="container mt-5 pt-5">
            <div class="row">
                <div class="col-md-6 mb-5">
                    <a href="index.html" class="navbar-brand">
                        <h1 class="mt-n2 text-uppercase text-white"><i class="fa fa-book-reader mr-3"></i>Burma Academy</h1>
                    </a>
                    <p class="m-0">Our platform offers a wide range of courses, from business and technology to creative arts and personal development. Our team of experienced instructors are experts in their fields and are committed to providing engaging and interactive learning experiences.</p>
                </div>
                <div class="col-md-6 mb-5">
                    <h3 class="text-white mb-4">Newsletter</h3>
                    <div class="w-100">
                        <b>"Unlock Your Potential with Burma Academy: Your Premier Online Education Destination!"</b> 
            ...
            <div class="row">
                <div class="col-md-4 mb-5">
                    ...
                    <p><i class="fa fa-map-marker-alt mr-2"></i>Tamwe, Yangon, Myanmar</p>
